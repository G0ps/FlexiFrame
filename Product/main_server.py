...
API_KEY = "<PUT YOUR GEMEINI API KEY HERE>"
...
file_a = 'v1_python_dict_prompt.txt'
file_b = 'v1_schema_prompt.txt'
...
HTML_FILE_PATH = "./UI.html"  # <-- replace this with your HTML file path
